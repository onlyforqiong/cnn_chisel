...
//                         round arbiter scheme has been overridden for this
//                         instance only.
//
//-----------------------------------------------------------------------------
...
module custom_BusMatrixArbiterM2 (
...
//  input port should be deselected.
  ...
  assign request = req_port0 | ( (iaddr_in_port == 2'b00) & HSELM &
                                (HTRANSM != 2'b00) );

  assign no_port_next     = ! ( HMASTLOCKM | request | HSELM );
  assign addr_in_port_next = ( request & !HMASTLOCKM ) ? 2'b00 : iaddr_in_port;
